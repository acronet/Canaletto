...
//here just for testing purposes
	...
	//PM10Qbit_init();
	//uint8_t dataCounter = 1;
	//while(1){
		//PM10Qbit_get_value(&PM10val);
		//sprintf_P(szBuf,PSTR("PM10 val %u = %f\t samples = %u\tmax = %u\tmin = %u\r\n"),dataCounter,PM10val.mean,PM10val.samples,PM10val.maxVal,PM10val.minVal);
